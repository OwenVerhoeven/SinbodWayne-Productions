/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 3fa4f72f9106ff456d6dce9876981492)
...
interface __BaseEnv_CloudflareBindings {
	...
	PROJECT_COLLABORATION: DurableObjectNamespace /* ProjectCollaborationHub */;
	ARCHIVE_WORKFLOW: Workflow /* ArchiveWorkflow */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "APP_TIMEZONE" | "APP_LOCALE" | "SESSION_IDLE_SECONDS" | "SESSION_ABSOLUTE_SECONDS" | "UPLOAD_MAX_BYTES" | "MULTIPART_THRESHOLD_BYTES" | "MULTIPART_PART_BYTES">> {}
}
