/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: e93cb4901219e67a09db11db46c36d5c)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	FILE_OBJECTS: KVNamespace;
	DB: D1Database;
	LOGIN_RATE_LIMITER: RateLimit;
	PUBLIC_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://productions.sinbodwayne.nl";
	APP_TIMEZONE: "Europe/Amsterdam";
	APP_LOCALE: "en-GB";
	SESSION_IDLE_SECONDS: "1800";
	SESSION_ABSOLUTE_SECONDS: "28800";
	UPLOAD_MAX_BYTES: "26214400";
	FILE_STORAGE_TOTAL_BUDGET_BYTES: "1000000000";
	FILE_STORAGE_BACKEND: "workers_kv_free";
	PROJECT_COLLABORATION: DurableObjectNamespace<import("./src/worker/index").ProjectCollaborationHub>;
	ARCHIVE_WORKFLOW: Workflow<Parameters<import("./src/worker/index").ArchiveWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "APP_TIMEZONE" | "APP_LOCALE" | "SESSION_IDLE_SECONDS" | "SESSION_ABSOLUTE_SECONDS" | "UPLOAD_MAX_BYTES" | "FILE_STORAGE_TOTAL_BUDGET_BYTES" | "FILE_STORAGE_BACKEND">> {}
}
