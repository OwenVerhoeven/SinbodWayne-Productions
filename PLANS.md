...
- [x] Configure local D1, private R2 binding, Workflow binding, and collaboration Durable Object.
...
- The Worker serves the SPA, typed API health response, security headers, request ID, authorized private R2 round trip, and print route.
...
- [x] Build immutable export snapshots and durable archive job/lease/heartbeat/attempt/idempotency state in R2/D1/Workflows.
...
- [ ] When authorized, create only unique production resources, apply reviewed remote migrations, run hidden bootstrap, attach only the production subdomain, deploy, and smoke test login/shell/D1/R2/recipient/print/readiness/archive. **Externally blocked:** Wrangler is unauthenticated and the production D1 identifier has not been supplied.
...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-08 | Use an npm TypeScript workspace with React/Vite, Hono Worker, D1, private R2, Workflows, and focused Durable Object collaboration. | Compact Cloudflare-native deployment with shared types and no mandatory paid SaaS.                 | Worker compatibility is a dependency gate.                                                                                                                              |
...
| 2026-08-08 | Keep R2 private and files versioned; stream through authorized routes or scoped operations.                                        | Prevent public listing and accidental version replacement.                                         | Completion must verify storage evidence and integrity.                                                                                                                  |
